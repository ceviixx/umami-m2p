...
def create_tables_and_indexes(postgres_cursor):
    ...
    # 5. Tabelle "website_event" erstellen
    postgres_cursor.execute("""
    ...
    # 6. Tabelle "event_data" erstellen
    postgres_cursor.execute("""
    ...
    # 7. Tabelle "session_data" erstellen
    postgres_cursor.execute("""
